...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative z-0 flex w-full flex-col items-center justify-center overflow-hidden rounded-md bg-background py-16 md:py-24",
        className,
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        ...
        <motion.div
          ...
          transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut" }}
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-accent/80 blur-2xl"
        />
        <motion.div
          initial={{ width: "15rem" }}
      ...
      <div className="relative z-50 flex -translate-y-40 flex-col items-center px-5 md:-translate-y-52">
        {children}
      </div>
    </div>
  );
